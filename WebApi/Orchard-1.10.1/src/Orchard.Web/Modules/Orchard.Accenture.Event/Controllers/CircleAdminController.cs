...
{
    [Admin]
    public class CircleAdminController : Controller
    {
        ...
        {
            if (!_orchardServices.Authorizer.Authorize(Permissions.ManageCircle, T("Not allowed to manage Circle.")))
                return new HttpUnauthorizedResult();

            var pager = new Pager(_siteService.GetSiteSettings(), pagerParameters);
            var query = _contentManager.Query(VersionOptions.Latest, "Circle");
