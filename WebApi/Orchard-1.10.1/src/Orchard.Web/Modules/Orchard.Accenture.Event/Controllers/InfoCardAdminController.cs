...
{
    [Admin]
    public class InfoCardAdminController : Controller
    {
        ...
        public InfoCardAdminController(
        ...
        {
            if (!_orchardServices.Authorizer.Authorize(Permissions.ManageInfoCard, T("Not allowed to manage InfoCard")))
                return new HttpUnauthorizedResult();

            var pager = new Pager(_siteService.GetSiteSettings(), pagerParameters);
            //var query = _contentManager.Query<InfoCardPart, InfoCardPartRecord>(VersionOptions.Latest);
            var query = _contentManager.Query(VersionOptions.Latest, "InfoCard");
