...
{
    [Admin]
    public class ParticipantAdminController : Controller {
        ...
        public ParticipantAdminController(
        ...
        {
            if (!_orchardServices.Authorizer.Authorize(Permissions.ManageParticipant, T("Not allowed to manage Participant")))
                return new HttpUnauthorizedResult();

            var pager = new Pager(_siteService.GetSiteSettings(), pagerParameters);
            //var query = _contentManager.Query<ParticipantPart, ParticipantPartRecord>(VersionOptions.Latest);
