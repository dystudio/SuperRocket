...
namespace Orchard.Accenture.Event.Controllers
{
    ...
    public class PollAdminController : Controller
    {
        ...
        {
            if (!_orchardServices.Authorizer.Authorize(Permissions.ManagePoll, T("Not allowed to manage Poll")))
                return new HttpUnauthorizedResult();

            var pager = new Pager(_siteService.GetSiteSettings(), pagerParameters);
            var query = _contentManager.Query(VersionOptions.Latest, "Poll");
